...
class SquadController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        users = [
            ...
            Developers(name: "Melquias Ribeiro", occupation: "Ocupação", phone: "(00)00000-0000", email: "funalo@mail.com", linkedin: "https://dominio.com.br", twitter: "user123", profile: "https://avatars.githubusercontent.com/u/54459438?v=4", description: "texto de exemplo"),
            Developers(name: "Felipe Brigagão", occupation: "Ocupação", phone: "(61)99460-5930", email: "felipe.brigagao@icloud.com", linkedin: "https://www.linkedin.com/in/felipebrigagaoalmeida/", twitter: "", profile: "https://avatars.githubusercontent.com/u/30760595?v=4", description: "texto de exemplo")
        ]
